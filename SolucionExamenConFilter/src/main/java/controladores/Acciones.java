...
public class Acciones {
    ...
    void accionTerminar(HttpSession sesion) throws IOException {
    	sesion.invalidate();
	...
	public void accionMasSaldo(String[] users) {
		    AccesoDatos db = AccesoDatos.initModelo();
		    db.actualizarSaldos(users);
		
	}

	public void accionBloquear(String[] users) {
	    AccesoDatos db = AccesoDatos.initModelo();
	    db.actualizarbloqueos(users);	
	}
}
